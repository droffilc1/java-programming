...
public class LotteryTicket {
    ...
    public static int[] generateNumbers() {
        ...
        for(int i = 0; i < LENGTH; i++) {
            int randomNumber;
            /* Generate random number and make sure it doesn't already
    ...
    public static boolean search(int[] array, int numberToSearchFor) {
        /*This is called an enhanced loop. It iterates through
        * the 'array' and each time assigns the current element to 'value'*/
        for(int value: array) {
